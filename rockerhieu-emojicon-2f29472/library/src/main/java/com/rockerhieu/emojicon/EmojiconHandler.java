...
public final class EmojiconHandler {
    ...
    private static final SparseArray<String> sStringMap = new SparseArray<String>(39);

    static {
    	// String mapping
    	sStringMap.put(0x1f3a3, "fish");
    	sStringMap.put(0x2615, "coffee");
    	sStringMap.put(0x1f375, "soup");
