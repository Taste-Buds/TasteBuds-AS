...
public class Emojicon implements Serializable {
    ...
    public static Emojicon fromCodePoint(int codePoint, String value) {
        Emojicon emoji = new Emojicon();
        emoji.emoji = newString(codePoint);
    ...
    public static Emojicon fromChar(char ch, String value) {
        Emojicon emoji = new Emojicon();
        emoji.emoji = Character.toString(ch);
        emoji.setEmojiVal(value);
        return emoji;
	...
	public String getEmojiVal() {
		return emojiVal;
	}

	public void setEmojiVal(String emojiVal) {
		this.emojiVal = emojiVal;
	}
}
